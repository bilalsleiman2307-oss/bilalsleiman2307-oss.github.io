...
const version = "trust-redesign-11";
...
function headerFor(config = null, slug = "") {
  if (!config) return `<header class="site-header"><div class="container-wide header-inner"><a class="brand" href="/"><img src="/assets/logo.jpeg?v=${version}" alt="Trust Schlüsseldienst Berlin Logo"><span><strong>Trust Schlüsseldienst</strong><small>Berlin · 24/7 erreichbar</small></span></a><button class="menu-toggle" type="button" aria-label="Menü öffnen" aria-expanded="false" aria-controls="main-nav">&#9776;</button><nav id="main-nav" class="main-nav"><a href="/">Startseite</a><a href="/leistung/">Leistungen</a><a href="/türöffnung-berlin-24h-notdienst/">Türöffnung</a><a href="/schlüsseldienst-berlin-preise/">Preise</a><a href="/schlüsseldienst-in-der-nähe/">Einsatzgebiete</a><a href="/ratgeber/">Ratgeber</a>${languageSwitcher("de")}</nav><div class="header-actions"><a class="button button-whatsapp" href="https://wa.me/493040563878">WhatsApp</a><a class="button button-primary" href="tel:${phone}">Jetzt anrufen</a></div></div></header>`;
  const pageUrl = `/${slug}/`;
  return `<header class="site-header"><div class="container-wide header-inner"><a class="brand" href="${pageUrl}"><img src="/assets/logo.jpeg?v=${version}" alt="Trust Schlüsseldienst Berlin"><span><strong>Trust Schlüsseldienst</strong><small>Berlin · 24/7</small></span></a><button class="menu-toggle" type="button" aria-label="${esc(config.nav.menu)}" aria-expanded="false" aria-controls="main-nav">&#9776;</button><nav id="main-nav" class="main-nav"><a href="${pageUrl}">${esc(config.nav.home)}</a><a href="#situations">${esc(config.nav.situations)}</a><a href="#services">${esc(config.nav.services)}</a><a href="#process">${esc(config.nav.process)}</a><a href="#prices">${esc(config.nav.prices)}</a><a href="#faq">${esc(config.nav.faq)}</a>${languageSwitcher(config.hreflang, config.nav.language)}</nav><div class="header-actions"><a class="button button-whatsapp" href="https://wa.me/493040563878">WhatsApp</a><a class="button button-primary" href="tel:${phone}">${esc(config.nav.call)}</a></div></div></header>`;
}
