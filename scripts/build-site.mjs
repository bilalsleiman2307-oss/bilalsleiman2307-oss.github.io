...
const header = `<header class="site-header"><div class="container-wide header-inner"><a class="brand" href="/"><img src="/assets/logo.jpeg?v=${version}" alt="Trust Schlüsseldienst Berlin Logo"><span><strong>Trust Schlüsseldienst</strong><small>Berlin · 24/7 erreichbar</small></span></a><button class="menu-toggle" aria-expanded="false" aria-controls="main-nav">Menü</button><nav id="main-nav" class="main-nav"><a href="/">Startseite</a><a href="/leistung/">Leistungen</a><a href="/schlüsseldienst-berlin-preise/">Preise</a><a href="/#einsatzgebiete">Einsatzgebiete</a><a href="/ratgeber/">Ratgeber</a></nav><div class="header-actions"><a class="button button-whatsapp" href="https://wa.me/491638516782">WhatsApp</a><a class="button button-primary" href="tel:${phone}">Jetzt anrufen</a></div></div></header>`;

const footer = `<footer class="site-footer"><div class="container-wide"><div class="footer-grid"><div><img class="footer-logo" src="/assets/logo.jpeg?v=${version}" alt="Trust Schlüsseldienst Berlin"><div class="footer-title">Trust Schlüsseldienst Berlin</div><p>Türöffnung, Schlosswechsel, Zylinderwechsel und Schlüsselnotdienst in Berlin – mit klarer Preisabsprache vor Beginn.</p><p><a href="tel:${phone}">${phoneDisplay}</a><br><a href="mailto:${email}">${email}</a></p></div><div><div class="footer-title">Leistungen</div><a href="/türöffnung-berlin-24h-notdienst/">Türöffnung Berlin</a><a href="/leistung/öffnung-bei-zugefallenen-türen/">Zugefallene Tür</a><a href="/leistung/öffnung-bei-abgeschlossenen-türen/">Abgeschlossene Tür</a><a href="/leistung/schlosswechsel-berlin-schlösser-schnell-sicher-wechseln/">Schlosswechsel</a></div><div><div class="footer-title">Informationen</div><a href="/schlüsseldienst-berlin-preise/">Preise</a><a href="/ratgeber/">Ratgeber</a><a href="/schlüsseldienst-in-der-nähe/">In der Nähe</a><a href="/impressum/">Impressum</a></div><div><div class="footer-title">Direktkontakt</div><a href="tel:${phone}">24/7 anrufen</a><a href="https://wa.me/491638516782">WhatsApp</a><a href="mailto:${email}">E-Mail</a></div></div><div class="footer-bottom"><span>© ${new Date().getFullYear()} Trust Schlüsseldienst Berlin</span><span>Schlüsseldienst und Türöffnung in Berlin.</span></div></div></footer><div class="mobile-callbar"><a class="button button-whatsapp" href="https://wa.me/491638516782">WhatsApp</a><a class="button button-primary" href="tel:${phone}">Jetzt anrufen</a></div>`;
...
function prices() { return `<section id="preise" class="section-soft"><div class="container"><div class="section-intro"><span class="eyebrow">Transparente Orientierung</span><h2>Preise für Türöffnung und Zylinderwechsel</h2><p>Alle Beträge inkl. MwSt. Anfahrt und mögliche Zusatzarbeiten werden telefonisch genannt und vor Arbeitsbeginn vereinbart.</p></div><div class="price-table-wrap"><table><thead><tr><th>Leistung</th><th>07–20 Uhr</th><th>20–00 Uhr</th><th>00–07 Uhr</th></tr></thead><tbody><tr><td>Zugefallene Tür öffnen</td><td>59 €</td><td>79 €</td><td>99 €</td></tr><tr><td>Abgeschlossene Tür öffnen</td><td>89 €</td><td>109 €</td><td>129 €</td></tr><tr><td>Zylinderwechsel</td><td>89 €</td><td>109 €</td><td>129 €</td></tr></tbody></table></div><p class="fine-print">Profilzylinder, Sicherheitsbeschläge und sonstiges Material sind nur nach ausdrücklicher Absprache Bestandteil des Auftrags.</p></div></section>`; }
...
function render(slug) {
  ...
  const main = isLegal ? `<section class="page-hero compact"><div class="container"><span class="eyebrow">Rechtliche Angaben</span><h1>Impressum</h1></div></section><section><div class="container"><div class="card legal-card"><h2>Anbieterkennzeichnung</h2><p><strong>Trust Schlüsseldienst Berlin</strong><br>Ramlerstr. 2<br>13355 Berlin<br>Deutschland</p><p>Telefon: <a href="tel:${phone}">${phoneDisplay}</a><br>E-Mail: <a href="mailto:${email}">${email}</a></p></div></div></section>` : `<section class="page-hero"><div class="container hero-layout"><div class="hero-copy"><span class="eyebrow">24/7 Schlüsselnotdienst in Berlin</span><h1>${esc(keyword)}</h1><p>${esc(intro)}</p><div class="hero-actions"><a class="button button-primary" href="tel:${phone}">Jetzt anrufen</a><a class="button button-whatsapp" href="https://wa.me/491638516782">WhatsApp</a><a class="button button-secondary" href="/schlüsseldienst-berlin-preise/">Preise ansehen</a></div><ul class="hero-points"><li>Preisabsprache vor Beginn</li><li>Möglichst schonende Türöffnung</li><li>24/7 in Berlin erreichbar</li></ul></div><div class="hero-visual"><div class="hero-visual-card"><span>Akuter Schlüsselfall?</span><strong>${phoneDisplay}</strong><p>Schildern Sie kurz, ob die Tür zugefallen oder abgeschlossen ist und in welchem Bezirk Sie sich befinden.</p><a class="button button-primary" href="tel:${phone}">Direkt verbinden</a></div></div></div></section>${trustBar}<section><div class="container"><div class="section-intro"><span class="eyebrow">Unsere Leistungen</span><h2>Professionelle Hilfe rund um Tür, Schloss und Sicherheit</h2><p>Jeder Einsatz beginnt mit einer klaren Einschätzung. Zusatzarbeiten oder Material erfolgen nur nach Absprache.</p></div><div class="grid-3"><a class="card" href="/leistung/öffnung-bei-zugefallenen-türen/"><span class="card-kicker">Türöffnung</span><h3>Zugefallene Tür</h3><p>Ist die Tür nur ins Schloss gefallen, ist in der Regel eine beschädigungsfreie Öffnung möglich.</p></a><a class="card" href="/leistung/öffnung-bei-abgeschlossenen-türen/"><span class="card-kicker">Türöffnung</span><h3>Abgeschlossene Tür</h3><p>Bei aktivem Riegel prüfen wir Schloss, Zylinder und Beschlag und erklären das Vorgehen vor Beginn.</p></a><a class="card" href="/leistung/schlosswechsel-berlin-schlösser-schnell-sicher-wechseln/"><span class="card-kicker">Sicherheit</span><h3>Schloss- & Zylinderwechsel</h3><p>Bei Verlust, Defekt oder Sicherheitsbedenken tauschen wir passende Komponenten nach Preisabsprache.</p></a></div></div></section><section class="section-blue"><div class="container"><div class="section-intro"><span class="eyebrow">So läuft es ab</span><h2>In vier klaren Schritten wieder Zugang erhalten</h2></div><div class="process-grid"><div class="process-step"><span>1</span><h3>Situation schildern</h3><p>Bezirk, Türart und ob die Tür zugefallen oder abgeschlossen ist.</p></div><div class="process-step"><span>2</span><h3>Preis klären</h3><p>Anfahrt, Leistung, Uhrzeit und mögliche Besonderheiten werden besprochen.</p></div><div class="process-step"><span>3</span><h3>Legitimation prüfen</h3><p>Die Berechtigung zur Öffnung wird vor Ort nachvollziehbar geprüft.</p></div><div class="process-step"><span>4</span><h3>Tür öffnen</h3><p>Wir wählen die zur Situation passende, möglichst schonende Methode.</p></div></div></div></section>${prices()}<section><div class="container split"><div><span class="eyebrow">Seriöser Ablauf</span><h2>Woran Sie einen fairen Schlüsseldienst erkennen</h2><p>Ein seriöser Ablauf beginnt nicht erst an der Tür. Fragen Sie nach Anfahrt, Grundpreis, Zuschlägen und möglichen Materialkosten. Bei Trust werden diese Punkte vor Beginn geklärt. Ein Zylinder oder Beschlag wird nicht ohne Ihre Zustimmung gewechselt.</p></div><div class="card"><h3>Vor dem Einsatz hilfreich</h3><ul class="mini-list"><li>Genaue Adresse und Berliner Bezirk</li><li>Tür nur zugefallen oder abgeschlossen?</li><li>Steckt ein Schlüssel von innen?</li><li>Besonderer Sicherheitsbeschlag vorhanden?</li><li>Ausweis oder andere Legitimation verfügbar?</li></ul></div></div></section>${districts()}<section class="section-soft"><div class="container"><div class="section-intro"><span class="eyebrow">Häufige Fragen</span><h2>Antworten zu ${esc(keyword)}</h2></div><div class="faq-list">${faqs.map(([q,a])=>`<details class="faq-item"><summary>${esc(q)}</summary><p>${esc(a)}</p></details>`).join("")}</div></div></section><section><div class="container"><div class="cta-panel"><div><h2>Jetzt Schlüsseldienst in Berlin anrufen</h2><p>Nennen Sie Bezirk und Türsituation. Wir besprechen Preis und Vorgehen vor Beginn.</p></div><div class="cta-actions"><a class="button button-primary" href="tel:${phone}">${phoneDisplay}</a><a class="button button-whatsapp" href="https://wa.me/491638516782">WhatsApp</a></div></div></div></section>`;
