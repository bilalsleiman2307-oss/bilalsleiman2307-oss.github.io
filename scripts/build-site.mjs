...
const version = "trust-redesign-13";
...
function headerFor(config = null, slug = "") {
  if (!config) return `<header class="site-header"><div class="container-wide header-inner"><a class="brand" href="/" aria-label="Trust Schlüsseldienst Berlin – Startseite"><img src="/assets/logo.jpeg?v=${version}" alt="Trust Schlüsseldienst Berlin Logo"></a><button class="menu-toggle" type="button" aria-label="Menü öffnen" aria-expanded="false" aria-controls="main-nav">&#9776;</button><nav id="main-nav" class="main-nav"><a href="/">Startseite</a><a href="/leistung/">Leistungen</a><a href="/türöffnung-berlin-24h-notdienst/">Türöffnung</a><a href="/schlüsseldienst-berlin-preise/">Preise</a><a href="/schlüsseldienst-in-der-nähe/">Einsatzgebiete</a><a href="/ratgeber/">Ratgeber</a></nav><div class="header-actions"><a class="button button-whatsapp" href="https://wa.me/493040563878">WhatsApp</a><a class="button button-primary" href="tel:${phone}">Jetzt anrufen</a></div>${languageSwitcher("de")}</div></header>`;
  const pageUrl = `/${slug}/`;
  return `<header class="site-header"><div class="container-wide header-inner"><a class="brand" href="${pageUrl}" aria-label="Trust Schlüsseldienst Berlin"><img src="/assets/logo.jpeg?v=${version}" alt="Trust Schlüsseldienst Berlin"></a><button class="menu-toggle" type="button" aria-label="${esc(config.nav.menu)}" aria-expanded="false" aria-controls="main-nav">&#9776;</button><nav id="main-nav" class="main-nav"><a href="${pageUrl}">${esc(config.nav.home)}</a><a href="#situations">${esc(config.nav.situations)}</a><a href="#services">${esc(config.nav.services)}</a><a href="#process">${esc(config.nav.process)}</a><a href="#prices">${esc(config.nav.prices)}</a><a href="#faq">${esc(config.nav.faq)}</a></nav><div class="header-actions"><a class="button button-whatsapp" href="https://wa.me/493040563878">WhatsApp</a><a class="button button-primary" href="tel:${phone}">${esc(config.nav.call)}</a></div>${languageSwitcher(config.hreflang, config.nav.language)}</div></header>`;
}
