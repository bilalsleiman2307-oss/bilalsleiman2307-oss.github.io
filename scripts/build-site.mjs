...
const homepageStyleVersion = "trust-redesign-15";
...
function homePrices() {
  return `<section id="preise" class="section-soft home-price-section"><div class="container"><div class="section-intro clean-intro"><span class="eyebrow">Preise mit Mehrwertsteuer</span><h2>Türöffnung ab 59 € – Festpreis am Telefon</h2><p>Der Preis ab 59 € gilt von 07 bis 20 Uhr für eine nur zugefallene, nicht abgeschlossene Tür. Die Abend-, Nacht-, Wochenend- und Feiertagspreise richten sich nach dem unten genannten Zeitfenster. Alle Beträge enthalten die Mehrwertsteuer.</p></div><div class="price-table-wrap"><table><thead><tr><th>Leistung</th><th>07–20 Uhr</th><th>20–00 Uhr</th><th>00–07 Uhr</th></tr></thead><tbody><tr><td>Zugefallene Tür öffnen</td><td>59 €</td><td>79 €</td><td>99 €</td></tr><tr><td>Abgeschlossene Tür öffnen</td><td>89 €</td><td>109 €</td><td>129 €</td></tr><tr><td>Zylinderwechsel</td><td>89 €</td><td>109 €</td><td>129 €</td></tr></tbody></table></div><div class="mobile-price-list"><article><h3>Zugefallene Tür</h3><p><span>07–20 Uhr</span><strong>59 €</strong></p><p><span>20–00 Uhr</span><strong>79 €</strong></p><p><span>00–07 Uhr</span><strong>99 €</strong></p></article><article><h3>Abgeschlossene Tür</h3><p><span>07–20 Uhr</span><strong>89 €</strong></p><p><span>20–00 Uhr</span><strong>109 €</strong></p><p><span>00–07 Uhr</span><strong>129 €</strong></p></article><article><h3>Zylinderwechsel</h3><p><span>07–20 Uhr</span><strong>89 €</strong></p><p><span>20–00 Uhr</span><strong>109 €</strong></p><p><span>00–07 Uhr</span><strong>129 €</strong></p></article></div><div class="home-price-notes"><p>Für den konkreten Auftrag schildern Sie am Telefon, ob die Tür zugefallen oder abgeschlossen ist, ob ein Schlüssel innen steckt und ob Schloss oder Beschlag bereits beschädigt sind. Danach werden Festpreis, Anfahrt und das vorgesehene Vorgehen vor der Anfahrt vereinbart.</p><p>Bei einer abgeschlossenen Tür, einem defekten Schloss oder zusätzlichen Arbeiten gilt der vorher besprochene Preis für diesen Fall. Profilzylinder, Schlösser, Beschläge und sonstiges Material gehören nicht automatisch zum Türöffnungspreis. Material wird nur nach ausdrücklicher Absprache eingesetzt und berechnet.</p><a class="button button-secondary" href="/schlüsseldienst-berlin-preise/">Alle Preise für den Schlüsseldienst Berlin</a></div></div></section>`;
}

function homePageContent(faqs) {
  const hero = `<section class="page-hero page-hero-image home-hero"><div class="container"><div class="hero-copy"><h1>Trust Schlüsseldienst Berlin ab 59 € – Festpreis am Telefon</h1><p class="home-hero-trust-line">24/7 erreichbar · in 10–30 Minuten vor Ort · Festpreis vor der Anfahrt am Telefon</p><p>Ist die Tür zugefallen oder abgeschlossen, sind Sie ausgesperrt oder ist der Schlüssel verloren oder abgebrochen, hilft Trust Schlüsseldienst Berlin im gesamten Stadtgebiet. Die Türöffnung einer nur zugefallenen Tür beginnt bei 59 €. Den Festpreis vereinbaren wir am Telefon. Die Anfahrt beträgt je nach Adresse und Verkehr 10 bis 30 Minuten.</p>${googleReviewBadge}<div class="home-hero-facts"><strong>Türöffnung ab 59 €</strong><span>24 Stunden täglich erreichbar</span><span>Anfahrt 10–30 Minuten</span></div><a class="home-hero-phone" href="tel:${phone}" aria-label="Trust Schlüsseldienst Berlin anrufen">${phoneDisplay}</a><div class="hero-actions"><a class="button button-primary" href="tel:${phone}">Jetzt anrufen</a><a class="button button-whatsapp" href="https://wa.me/493040563878">WhatsApp</a><a class="button button-secondary" href="#preise">Preise ansehen</a></div></div></div></section>`;
  ...
  return `${hero}${situations}${homePrices()}${process}${services}${damageFree}${districts(true)}${reasons}${reviewsSection("")}${security}${faqSection("", "Schlüsseldienst Berlin", faqs)}${contactCta}`;
}
